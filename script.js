...
function updatePatientUI(profile) {
    ...
    if (bloodGroupCardEl) bloodGroupCardEl.innerText = profile.blood_group || "O+";
...
function renderHistoryTable(history) {
    ...
    if (history.length === 0) {
        ...
        cell.colSpan = 5;
        cell.innerHTML = "<em style='color: #64748b;'>No telemetry logs found in database. Click 'Simulate PPG Sensor' above to record one!</em>";
...
function renderPatientInfoHistoryTable(history) {
    ...
    if (history.length === 0) {
        ...
        const cell = row.insertCell(0);
        cell.colSpan = 5;
        cell.innerHTML = "<em style='color: #64748b;'>No telemetry logs found in database. Click 'Simulate PPG Sensor' on the Dashboard tab to record one!</em>";
        cell.style.padding = "20px";
        return;
    }
